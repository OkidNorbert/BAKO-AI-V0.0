...
const CoachDashboard = () => {
  ...
  const handleTakeAttendance = async () => {
    try {
      ...
      // window.location.href = '/player/attendance';
    } catch (error) {
  ...
  const handleViewSchedule = async () => {
    try {
      ...
      // window.location.href = '/player/schedule';
    } catch (error) {
              ...
              <div className="space-y-4">
                {children.length > 0 ? (
                  ...
                  <div className={`flex flex-col items-center justify-center py-10 ${
                    ...
                    <p className="text-center">No players assigned today</p>
                  </div>
                )}
              </div>
            </div>

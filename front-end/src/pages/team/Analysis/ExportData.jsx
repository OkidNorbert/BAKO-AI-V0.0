...
const ExportData = () => {
  ...
  const handleExport = async (values) => {
    ...
    try {
      ...
      // Construct URL
      const url = `/api/team/export/${exportCategory}/${exportType}?${queryParams.toString()}`;
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <Button
                  type="button"
                  variant={exportCategory === 'players' ? 'default' : 'outline'}
                  onClick={() => setExportCategory('players')}
                  className="w-full justify-start"
                >

...
const UserManagement = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      if (error.response && error.response.status === 401) {
        ...
        setError('Failed to fetch coach members. Please try again later.');
      }
    } finally {
      setLoading(false);
    }
  ...
  const handleAddButtonClick = (role) => {
    if (role === 'coach') {
      ...
      navigate('/team/coach-registration');
    } else {
    ...
    return (
      <div className={`flex items-center justify-center min-h-screen ${isDarkMode
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className={`mt-4 text-lg ${isDarkMode ? 'text-white' : 'text-indigo-700'}`}>Loading coach data...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className={`min-h-screen ${isDarkMode
      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className={`mt-1 text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              Create and manage user accounts for coaches and administrators
            </p>
          </div>
        ...
        {/* Information banner about activating coaches */}
        <div className={`border-l-4 p-4 mb-6 rounded-md ${isDarkMode
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm">
                <p>Coaches must be <strong>activated</strong> before they can start their duties. Find any coach with "Pending" status and click the "Activate" button to enable them to manage players and track statistics.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search coach members..."
                  value={searchTerm}
            ...
            <div className="flex-1">
              <div className={`flex items-center px-3 py-2 rounded-lg ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'
                }`}>
                <Filter size={18} className={isDarkMode ? 'text-gray-300' : 'text-gray-700'} />
                <select
                  value={filterRole}
                  onChange={(e) => setFilterRole(e.target.value)}
                  className={`ml-2 bg-transparent border-none focus:ring-0 ${isDarkMode ? 'text-white' : 'text-gray-800'
                    }`}
                >
            ...
            <div className="flex-1">
              <button
                onClick={fetchUsers}
                className={`p-2 rounded-lg transition-colors ${isDarkMode ? 'bg-gray-700 hover:bg-gray-600 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-700'
                  }`}
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredUsers.length > 0 ? (
                  filteredUsers.map((user) => (
                    <tr key={user.id} className={`${isDarkMode
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                        <div className="flex items-center justify-end space-x-2">
                          <button
                            ...
                            className={`p-1.5 rounded-full transition-colors ${user.status === 'active'
                  ...
                  <tr key="no-results">
                    <td colSpan="5" className="px-6 py-10 text-center">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm">No coach members found matching your search criteria.</p>
                        <button
                          onClick={() => {
                            setSearchTerm('');
                            setFilterRole('all');
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className={`rounded-2xl p-6 max-w-md w-full overflow-y-auto max-h-[90vh] shadow-2xl transform transition-all duration-300 ${isDarkMode
              ? 'bg-gradient-to-b from-gray-800 to-gray-900 border border-purple-900/30'
              : 'bg-white border border-purple-100'
            }`}>
            <div className="flex justify-between items-center mb-6">
              <div>
                <h2 className={`text-2xl font-bold ${isDarkMode
            ...
            <form onSubmit={handleAddUser} className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className={`w-full px-4 py-2.5 rounded-xl shadow-sm ${isDarkMode
                ...
                <div className="flex justify-between items-center mb-1.5">
                  ...
                  <div className="flex items-center">
                    ...
                    <div
                      ...
                      className={`relative inline-flex items-center h-5 rounded-full w-10 cursor-pointer transition-colors ease-in-out duration-200 ${useGeneratedPassword
                          ? isDarkMode ? 'bg-yellow-500' : 'bg-purple-500'
                          : isDarkMode ? 'bg-gray-600' : 'bg-gray-300'
                        }`}
                    >
                      <span
                        className={`inline-block w-4 h-4 transform rounded-full bg-white shadow-md transition ease-in-out duration-200 ${useGeneratedPassword ? 'translate-x-5' : 'translate-x-1'
                          }`}
                      />
                    </div>
                  </div>
                ...
                {useGeneratedPassword ? (
                  <div className="relative">
                    <input
                      ...
                      readOnly
                      className={`w-full px-4 py-2.5 pr-20 rounded-xl shadow-sm font-mono ${isDarkMode
              ...
              <div className="flex items-center justify-end space-x-3 mt-6">
                <button
                  type="button"
                  onClick={() => setShowAddModal(false)}
                  className={`px-5 py-2.5 rounded-full transition-all duration-200 transform hover:scale-105 ${isDarkMode
                ...
                <button
                  type="submit"
                  className={`px-5 py-2.5 rounded-full shadow-lg transition-all duration-200 transform hover:scale-105 ${isDarkMode
                      ? modalRole === 'admin'
              ...
              <div className="mb-3">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <button
                    ...
                    className={`p-1 rounded-md text-xs flex items-center ${isDarkMode
                ...
                <div className={`font-mono text-sm p-2 rounded ${isDarkMode ? 'bg-gray-800' : 'bg-white border border-gray-300'
                  }`}>
      ...
      {showEditModal && selectedUser && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className={`rounded-lg p-6 max-w-md w-full overflow-y-auto max-h-[90vh] ${isDarkMode ? 'bg-gray-800' : 'bg-white'
            }`}>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    readOnly
                    className={`w-full px-3 py-2 pr-20 rounded-md ${isDarkMode
                        ? 'bg-gray-700 text-white'
                        : 'bg-gray-50 text-gray-900'
                      }`}
                  />

...
const SystemSettings = () => {
  const [settings, setSettings] = useState({
    ...
    maxCoachRatio: 5,
    matchRetentionDays: 30,
    trainingRetentionDays: 15
  });
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className={`mb-6 p-6 rounded-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-2">Basketball Academy Name</label>
              <input
                type="text"
        ...
        <div className={`mb-6 p-6 rounded-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium mb-2">Match Analysis Retention (Days)</label>
              <input
                type="number"
                value={settings.matchRetentionDays}
                onChange={(e) => handleSettingChange('matchRetentionDays', parseInt(e.target.value))}
                className={`w-full p-2 rounded-md ${isDarkMode
                    ? 'bg-gray-700 text-white'
                    : 'bg-gray-50 text-gray-900'
                  }`}
            ...
            <div>
              <label className="block text-sm font-medium mb-2">Training Clip Retention (Days)</label>
              <input
                type="number"
                value={settings.trainingRetentionDays}
                onChange={(e) => handleSettingChange('trainingRetentionDays', parseInt(e.target.value))}
                className={`w-full p-2 rounded-md ${isDarkMode
                    ? 'bg-gray-700 text-white'
                    : 'bg-gray-50 text-gray-900'
                  }`}

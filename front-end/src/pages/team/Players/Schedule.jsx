...
const Schedule = () => {
  ...
  const fetchCoachsAndPlayers = async () => {
    try {
      ...
      const [coachsResponse, playersResponse] = await Promise.all([
  ...
  const handlePlayersChange = (e) => {
    ...
    setNewEvent({ ...newEvent, players: selectedOptions });
  };
  ...
  const handleEditPlayersChange = (e) => {
    const selectedOptions = Array.from(e.target.selectedOptions, option => option.value);
    setEditingEvent({ ...editingEvent, players: selectedOptions });
  };
